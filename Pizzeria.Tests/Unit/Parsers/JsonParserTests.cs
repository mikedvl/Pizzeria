...
public class JsonParserTests
{
    ...
    {
        var path = TestFileHelper.GetResourcePath("orders.json");
    ...
    {
        var path = TestFileHelper.GetResourcePath("products.json");
    ...
    {
        var path = TestFileHelper.GetResourcePath("ingredients.json");
